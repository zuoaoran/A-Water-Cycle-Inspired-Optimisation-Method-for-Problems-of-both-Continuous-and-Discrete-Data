function [ Scorebest, Xbest,Convergence_curve]=atmo_rain(Materials_no, Max_iter, lb,ub, dim,C3,C4,...
...
disp('atmo_rain is now estimating the global optimum for your problem....')
flag=0;
